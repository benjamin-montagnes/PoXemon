...
public:
    ...
    Bullet_Attack1(int ptype): Bullet() {
        ...
        if(type == 20){
            ...
            if (!bpic.loadFromFile("Images/waterball.png")) std::cout << "could not load attack 1 water image" << std::endl;
            bpic.loadFromFile("Images/waterball.png");
            if (!deleting_pic.loadFromFile("Images/waterball.png")) std::cout << "could not load attack 1 water explode image" << std::endl;
            deleting_pic.loadFromFile("Images/waterball.png");}
        if(type == 30){
        ...
        if(type == 40){
            ...
            if (!bpic.loadFromFile("Images/fireball_explode.png")) std::cout << "could not load attack 1 fire image" << std::endl;
            bpic.loadFromFile("Images/fireball_explode.png");
