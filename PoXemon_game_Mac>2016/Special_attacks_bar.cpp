...
Special_Attacks_Bar::Special_Attacks_Bar() {
	...
	if (!bg_tex.loadFromFile("Images/Special_Attacks_Bar/attackbar.png")) { std::cout << "could not load attackbar bg" << std::endl; }
	bg_tex.loadFromFile("Images/Special_Attacks_Bar/attackbar.png");
