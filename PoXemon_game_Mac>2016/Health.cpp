...
Healthbar::Healthbar(){
    //Text
    if (!font.loadFromFile("Fonts/upheavtt.ttf")) { std::cout << "could not load bullet_bar font" << std::endl; }
...
//    bar.setScale(sf::Vector2f(0.2,0.2));
    bar.setScale(sf::Vector2f(0.4,0.4));
...
//    heart.setScale(sf::Vector2f(0.55, 0.55));
    heart.setScale(sf::Vector2f(1.10, 1.10));
...
//    healthbar.setSize(sf::Vector2f(120,15));
    healthbar.setSize(sf::Vector2f(240,30));
