...
using namespace std;
 ...
 int main()
 {
     ...
     if (!battle_music.openFromFile("Sprites/battle.ogg")) std::cout << "Error loading music" << std::endl;
     sf::Music heal_music;
     if (!heal_music.openFromFile("Sprites/heal.ogg")) std::cout << "Error loading music" << std::endl;
        
     string current = map1.map_name;
     string c_state = Arthur.state;
     int battle_k = 0;
     ...
     while (window.isOpen())
     {
         ...
         if(Arthur.state != c_state){
             if(Arthur.state == "healed"){
                 music3.stop();
                 heal_music.play();
                 heal_music.setLoop(false);
                 while (heal_music.getStatus() == 2);
                 heal_music.stop();
                 music3.play();
                 music3.setLoop(true);
                 Arthur.state = "Healing";

             }
             if(Arthur.state == "Fighting"){
                 if (current == "first") music.pause();
                 else if (current == "pokeShop") music2.pause();
                 else if (current == "pokeCenter") music3.pause();
                 else if (current == "pokeCenter2") music3.pause();
                 else if (current == "hall") music4.pause();
                 else if (current == "second") music5.pause();
                 else if (current == "home") music6.pause();
                 else if (current == "third") music7.pause();
                 else if (current == "interior_80") music8.pause();
                 else if (current == "maze") music9.pause();
                 else if (current == "room_clement") music10.pause();
                 else if (current == "fourth") music11.pause();
                 else if (current == "bossfinal") music12.pause();
                 else music.pause();
                 ...
                 else if (map1.map_name == "pokeCenter2"){
                     music3.play();
                     music3.setLoop(true);
                 }
         ...
         if(map1.map_name != current){
                ...
                else if (current == "pokeCenter2") music3.stop();
