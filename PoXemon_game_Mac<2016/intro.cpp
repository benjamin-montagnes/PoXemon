...
int menu(std::string picture) {
    ...
    title.setPosition(WindowSize.x*(0.39), WindowSize.y*(0.65));
...
int loadgame(std::string picture) {
    ...
    title.setStyle(sf::Text::Bold);
    title.setFillColor(sf::Color::Black);
    title.setPosition(WindowSize.x*(0.21), WindowSize.y*(0.60));
    ...
    // Create an explanation
    sf::Text expl("or click on New Game", font, 30);
    expl.setStyle(sf::Text::Bold);
    expl.setFillColor(sf::Color::Black);
    expl.setPosition(WindowSize.x*(0.76), WindowSize.y*(0.90));
    ...
    expl2.setPosition(WindowSize.x*(0.515), WindowSize.y*(0.85));
    
    sf::Text gamepath("", font, 20);
    ...
    sf::RectangleShape choice1(sf::Vector2f(500.f, 50.f));
    choice1.setOutlineThickness(5.f);
    choice1.setOutlineColor(sf::Color(1, 1, 1));
    choice1.setPosition(WindowSize.x*(0.35), WindowSize.y*(0.75));
...
int intro(std::string picture, bool side, int which) {
    ...
    professor.scale(sf::Vector2f(0.1f, 0.1f)); //Set scale
    
    // Create a dialogue box
    sf::RectangleShape dialogue(sf::Vector2f(1200.f, 300.f));
